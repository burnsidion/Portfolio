<template>
    <div :style="parentStyles" :class="
  cn(
    'relative grid min-h-[60px] w-full max-w-full place-items-center rounded-[--border-radius] bg-white p-3 text-black dark:bg-black dark:text-white glow-border',
    $props.class,
  )
">
        <div :style="childStyles" :class="
        cn(
